...
<body>
    <div class="container">
		...
		$vl_va = $vlt - $vf;
			...
			echo "<p><strong>Valor da Conta:</strong> R$ " . number_format($vl_pg, 2, ',', '.') . "</p>";
			echo "<p><strong>Percentual de Gorjeta:</strong> " . ($pg * 100) . "%</p>";
			echo "<p><strong>Percentual de Gorjeta:</strong> " . number_format($vl_pg, 2, ',', '.') . "</p>";
		...
		if ($va == 1.0) {
			...
			echo "<p><strong>Valor da Área:</strong> R$ " . number_format($vl_va * -1, 2, ',', '.') . "</p>";
			echo "<p><strong>Valor da Área:</strong> R$ " . number_format($vf, 2, ',','.') . "</p>";
			echo"</div>";
	}
		?>
    </div>
